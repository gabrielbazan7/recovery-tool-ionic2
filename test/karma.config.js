  ...
  config.set({
    ...
    files: [
...

      {
        ...
        pattern: 'node_modules/ionic-angular/**/*.js',
        included: false,
        watched: false
      }, {
        pattern: 'node_modules/ionic-native/dist/**/*.js',
        included: false,
        served: true
      }, {
        ...
        pattern: 'www/build/test/**/*.js',
        included: false,
        watched: true
      },
      {
        pattern: 'node_modules/lodash/index.js',
        included: false,
        watched: false,
        served: true,
      }, 
    ...
    proxies: {
      ...
      //https://forum.ionicframework.com/t/unit-test-configuration/44973/3
      ...
      //
      '/base/lodash.js': '/base/node_modules/lodash/index.js',
    },
